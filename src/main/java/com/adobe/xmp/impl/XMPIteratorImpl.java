...
/**
 * The <code>XMPIterator</code> implementation. Iterates the XMP Tree according to a set of options.
 * During the iteration the XMPMeta-object must not be changed. Calls to <code>skipSubtree()</code>
 * / <code>skipSiblings()</code> will affect the iteration.
 * 
 * @since 29.06.2006
 */
public class XMPIteratorImpl implements XMPIterator {
  ...
  /**
   * The <code>XMPIterator</code> implementation. It first returns the node itself, then recursivly
   * the children and qualifier of the node.
   * 
   * @since 29.06.2006
   */
  private class NodeIterator implements Iterator<Object> {
    ...
    /**
     * Calls hasNext() and returnes the prepared node. Afterwards its set to null. The existance of
     * returnProperty indicates if there is a next node, otherwise an exceptio is thrown.
     * 
     * @see Iterator#next()
     */
    public Object next() {
  ...
  /**
   * This iterator is derived from the default <code>NodeIterator</code>, and is only used for the
   * option {@link IteratorOptions#JUST_CHILDREN}.
   * 
   * @since 02.10.2006
   */
